...
let names_to_ints ast =
  ...
  Hashtbl.add label_map "/:SelfArg:Arg0" (Int64.of_int 193);
  Hashtbl.add label_map "%:SelfArg:Arg0" (Int64.of_int 254);
  Hashtbl.add label_map "=:SelfArg:Arg0" (Int64.of_int 306);
  Hashtbl.add label_map "!=:SelfArg:Arg0" (Int64.of_int 355);
  Hashtbl.add label_map "<:SelfArg:Arg0" (Int64.of_int 362);

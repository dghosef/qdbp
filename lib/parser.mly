...
prototype_field:
| id = upper_id; LBRACE; a = arg_list; e = expr; RBRACE
  {AstCreate.make_prototype_field id a e $loc}
| id = upper_id; LBRACE; e = expr; RBRACE
  {AstCreate.make_prototype_field id [] e $loc}
